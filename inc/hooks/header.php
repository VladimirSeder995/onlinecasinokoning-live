...
if ( ! function_exists( 'zakra_header_main' ) ) :
	...
	function zakra_header_main() {
		...
		if ( ! get_theme_mod( 'zakra_enable_dual_menu', false ) ) {
			...
			<div class="mobile-search-wrap hide">
				<div class="mobile-search-inner">
					<form role="search" method="get" class="search-form" action="<?php echo home_url('/'); ?>">
						<label>
							<input autocomplete="off" name="s" value="<?php echo get_search_query(); ?>" type="text" class="casino-search-input" placeholder="Zoeken …">
							<span class="mobile-search-submit"></span>
						</label>
					</form>
					<div class="mobile-search-results">
					</div><!-- .mobile-search-results -->
				</div><!-- .mobile-search-inner -->
	...
	function zakra_header_main_action() {
		...
		<nav id="header-action" class="<?php zakra_css_class( 'zakra_header_action_class' ); ?>">
			<ul class="tg-header-action-list">
				<li class="tg-header-action__item">
...
<?php
			...
			if ( $meta_logo_id ) {
				$meta_logo_attr = array(
					'class'    => 'tg-logo custom-menu-mobile-logo',
					'itemprop' => 'logo',
				);
...
if ( ! function_exists( 'zakra_page_header' ) ) :
	...
	function zakra_page_header() {
		...
		<div class="tg-page-header <?php echo esc_attr( $style ); ?>">
