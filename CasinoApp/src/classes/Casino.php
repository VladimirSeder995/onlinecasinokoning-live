    ...
    public function getPositionHTML() {
            ...
            if( $this->position == 0 ){
                if( $first_place_image = get_field( 'first_place_image', 'option' ) ) {
                    ...
                    $position_html = "<img src='". get_stylesheet_directory_uri() . '/assets/img/images/gold-badge.png' ."' alt='first_place_image'/>";
                }
            }
            elseif( $this->position == 1 ) {
                if( $second_place_image = get_field( 'second_place_image', 'option' ) ) {
                    ...
                    $position_html = "<img src='". get_stylesheet_directory_uri() . '/assets/img/images/silver-badge.png' ."' alt='second_place_image'/>";
                }
            }
            elseif( $this->position == 2 ) {
                if( $third_place_image = get_field( 'third_place_image', 'option' ) ) {
                    ...
                    $position_html = "<img src='". get_stylesheet_directory_uri() . '/assets/img/images/bronze-badge.png' ."' alt='third_place_image'/>";
                }
            }
            else
